...
echo 'GC ndof=2 #1 90\% CL' `fillrow 6 9` '\\\\ \hline'
echo 'GC ndof=2 #2 90\% CL' `fillrowerr 2 6 8` '\\\\ \hline'
echo 'GC #3 90% C.L. area (deg$^2$)' `fillrow 4 9` '\\\\ \hline' 
echo 'GC ndof=2 #1 68\% CL' `fillrow 5 9` '\\\\ \hline'
echo 'GC ndof=2 #2 68\% CL' `fillrowerr 1 6 8` '\\\\ \hline'
echo 'GC #3 68% C.L. area (deg$^2$)' `fillrow 4 9` '\\\\ \hline'

echo 'GC #2 90% real coverage (%)' `fillrowerr 1 12 14` '\\\\ \hline'
echo 'GC #2 68% real coverage (%)' `fillrowerr 2 12 14` '\\\\ \hline'
